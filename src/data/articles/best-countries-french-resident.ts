 ...
 * @/data/countries at module load; nothing is restated by hand.
 */
...
const ranked = [ie, ch, se, at, de, ca, jp];
...
const frContent: ArticleBlock[] = [
  ...
  {
    type: "p",
    text: `Quatre pays manquent volontairement à ce tableau : les États-Unis et l'Australie, où le potentiel dépend entièrement de votre situation, et le Royaume-Uni et les Pays-Bas, où il est nul pour un particulier — chacun est traité plus bas.`,
  },
  { type: "h2", text: `Le podium et les poursuivants, pays par pays` },
  { type: "h3", text: `1. Irlande — ${pts(gapFR(ie), "fr")} points, le cas le plus spectaculaire` },
  {
    type: "p",
  ...
  },
  {
    ...
    footnote: `Exemple pour ${eur(IE_GROSS, "fr")} de dividendes irlandais bruts — montants indicatifs, données revues en juin 2026.`,
  },
  { type: "h3", text: `2. Suisse — ${pts(gapFR(ch), "fr")} points, le plus gros gisement en volume` },
  {
    type: "p",
  ...
  { type: "h3", text: `3. Suède — ${pts(gapFR(se), "fr")} points, l'administration réactive` },
  {
    type: "p",
  ...
  { type: "h3", text: `4. Autriche — ${pts(gapFR(at), "fr")} points, le délai le plus confortable` },
  {
    type: "p",
  ...
  { type: "h3", text: `5. Allemagne — ${pts(gapFR(de), "fr")} points, exigeante mais rentable` },
  {
    type: "p",
  ...
  { type: "h3", text: `6. Canada — ${pts(gapFR(ca), "fr")} points, le contre-la-montre` },
  {
    type: "p",
  ...
  { type: "h2", text: `Les zéros assumés : Royaume-Uni et Pays-Bas` },
  {
    type: "p",
  ...
  },
  {
    ...
    text: `Le Canada illustre le vrai enjeu : ${pts(gapFR(ca), "fr")} points de potentiel, mais ${yearsFr(ca)} seulement pour agir. Avant de prioriser par écart, vérifiez ce qui expire en premier avec le [calculateur de prescription](${href("fr", "solCalculator")}) — gratuit, sans compte.`,
  },
    ...
    items: [
      {
        ...
        answer: `Non : ce qui compte, c'est l'écart multiplié par vos dividendes bruts dans chaque pays — et le délai restant. Dix points sur un gros portefeuille canadien valent plus que vingt-cinq points sur une ligne irlandaise isolée, surtout à deux ans de la prescription. Le simulateur croise les trois variables sur vos chiffres réels.`,
      },
      {
      ...
      {
        question: `Pourquoi l'Irlande tombe-t-elle à 0 % quand la France impose mes dividendes ?`,
        answer: `Ce sont deux impôts distincts. L'exonération irlandaise porte sur la retenue à la source irlandaise, ouverte aux résidents de pays conventionnés ; elle ne change rien à l'imposition française de vos dividendes, qui suit son cours normal. Récupérer la retenue étrangère n'est pas de l'optimisation : c'est l'application du taux prévu par les textes.`,
      },
      {
        question: `Ces taux peuvent-ils changer ?`,
        answer: `Oui — conventions renégociées, législations internes modifiées, pratiques administratives durcies ou assouplies. C'est pourquoi chaque chiffre de cette page est présenté comme indicatif avec sa date de revue (juin 2026), et pourquoi chaque dossier est revérifié contre les règles en vigueur avant tout dépôt.`,
      },
      {
...
const enContent: ArticleBlock[] = [
  ...
  {
    type: "p",
    text: `The figures below are indicative (data reviewed in June 2026): treaties and administrative practice evolve, and every file is re-checked before filing. The deadlines shown are statutes of limitations — [their detailed ranking has its own article](${articleHref("en", SOL_RANKING_SLUG.en)}).`,
  },
  { type: "h2", text: `The ranking in one table` },
  {
    type: "table",
    caption: `Recoverable gap for an individual French resident, in percentage points of the gross dividend. Data reviewed in June 2026 — indicative figures.`,
  ...
  {
    type: "p",
    text: `Four countries are deliberately missing from this table: the United States and Australia, where the potential depends entirely on your situation, and the United Kingdom and the Netherlands, where it is nil for an individual — each is covered below.`,
  },
  { type: "h2", text: `The podium and the chasing pack, country by country` },
  { type: "h3", text: `1. Ireland — ${pts(gapFR(ie), "en")} points, the most spectacular case` },
  {
    type: "p",
  ...
  },
  {
    ...
    footnote: `Example for ${eur(IE_GROSS, "en")} of gross Irish dividends — indicative amounts, data reviewed in June 2026.`,
  },
  { type: "h3", text: `2. Switzerland — ${pts(gapFR(ch), "en")} points, the biggest pool by volume` },
  {
    type: "p",
  ...
  { type: "h3", text: `3. Sweden — ${pts(gapFR(se), "en")} points, the responsive administration` },
  {
    type: "p",
  ...
  { type: "h3", text: `4. Austria — ${pts(gapFR(at), "en")} points, the most comfortable deadline` },
  {
    type: "p",
  ...
  { type: "h3", text: `5. Germany — ${pts(gapFR(de), "en")} points, demanding but worth it` },
  {
    type: "p",
  ...
  { type: "h3", text: `6. Canada — ${pts(gapFR(ca), "en")} points, the race against the clock` },
  {
    type: "p",
  ...
  { type: "h2", text: `The honest zeros: the United Kingdom and the Netherlands` },
  {
    type: "p",
  ...
  },
  {
    ...
    text: `Canada illustrates the real stake: ${pts(gapFR(ca), "en")} points of potential, but only ${yearsEn(ca)} to act. Before prioritising by gap, check what expires first with the [deadline calculator](${href("en", "solCalculator")}) — free, no account.`,
  },
    ...
    items: [
      {
        ...
        answer: `No: what matters is the gap multiplied by your gross dividends in each country — and the time remaining. Ten points on a large Canadian portfolio beat twenty-five points on one isolated Irish line, especially with a two-year clock. The simulator crosses all three variables against your actual figures.`,
      },
      {
      ...
      {
        question: `Why does Ireland drop to 0% when France still taxes my dividends?`,
        answer: `They are two separate taxes. The Irish exemption concerns Irish withholding at source, open to treaty-country residents; it changes nothing about the French taxation of your dividends, which runs its normal course. Recovering foreign withholding is not tax optimisation: it is the rate the rules already provide.`,
      },
      {
        question: `Can these rates change?`,
        answer: `Yes — treaties get renegotiated, domestic law moves, administrative practice tightens or loosens. That is why every figure on this page is flagged as indicative with its review date (June 2026), and why every file is re-checked against the rules in force before anything is filed.`,
      },
      {
...
export const bestCountriesFrenchResident: Article = {
  ...
  description: {
    fr: `Irlande, Suisse, Suède en tête — Royaume-Uni et Pays-Bas à zéro, et nous le disons. Le classement des ${COUNTRIES.length} pays par écart récupérable pour un particulier résident de France, avec les pièges de chacun.`,
    en: `Ireland, Switzerland and Sweden on top — the UK and the Netherlands at zero, and we say so. All ${COUNTRIES.length} countries ranked by recoverable gap for an individual French resident, with each one's traps.`,
  },
  updated: "2026-07-08",
  readingMinutes: 10,
  content: { fr: frContent, en: enContent },
  relatedCountries: ["IE", "CH", "SE", "AT", "DE", "CA", "JP", "AU", "US", "GB", "NL"],
};
